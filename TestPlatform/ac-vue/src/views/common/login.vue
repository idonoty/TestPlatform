                ...
                if (valid) {
                    this.$http({
                        ...
                        if (data && data.code === 0) {
                            ...
                            //get info --> set profile
                            var userInfo = data.user
                            if (userInfo.hobbies != null && userInfo.hobbies != undefined) {
                                userInfo.hobbies = userInfo.hobbies.split(",")
                            }
                            AnalysysAgent.profileSet(userInfo)
                            //alias
                            AnalysysAgent.alias(userInfo.userId.toString());
                            this.$router.replace({
                                name: 'home'
                            })
                        } else {
