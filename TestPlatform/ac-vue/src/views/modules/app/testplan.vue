<template>
  <div class="mod-config">
    ...
    <el-table :data="dataList" border v-loading="dataListLoading" @selection-change="selectionChangeHandle" style="width: 100%">
      ...
      <el-table-column prop="cookie" header-align="center" align="center" show-overflow-tooltip label="appkey"></el-table-column>
      <el-table-column prop="progress" header-align="center" align="center" show-overflow-tooltip label="执行进度"></el-table-column>
      <el-table-column fixed="right" header-align="center" align="center" width="150" label="操作">
        <template slot-scope="scope">
          <el-button type="text" size="small" @click="updateHandle(scope.row.testplanId)">修改</el-button>
...
<script>
  import update from "./testplan-update";
  ...
  export default {
    ...
    methods: {
      ...
      refreshDataList() {
        ...
        this.$http({
          url: this.$http.adornUrl("/app/testplan/list"),
          method: "get",
