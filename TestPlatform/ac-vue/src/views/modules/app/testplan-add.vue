<template>
  <el-dialog :title="!dataForm.id ? '新增' : '修改'" :close-on-click-modal="false" :visible.sync="visible" width="626px">
...
<!--      <el-form-item label="计划名称" prop="testplanName">
      ...
      <el-row :gutter="100">
		  <el-col span="10">
		    <el-form-item label="计划名称" prop="testplanName">
		      <el-input v-model="dataForm.testplanName" placeholder="计划名称"  style="width: 180px"></el-input>
		    </el-form-item>
		  </el-col>
        <el-col span="10">
        ...
        <el-col span="10">
          <el-form-item label="模块" prop="moduleName">
            <el-select v-model="dataForm.moduleName" multiple collapse-tags placeholder="选择项目后再选模块" style="width: 180px">
		...
		<el-col span="10">
		  <el-form-item label="用例版本" prop="version">
		    <el-select v-model="dataForm.version" clearable filterable placeholder="选择项目后再选版本" style="width: 180px">
      ...
      dataFormSubmit() {
        this.$refs['dataForm'].validate((valid) => {
          if (valid) {
            ...
            this.$http({
              url: this.$http.adornUrl(`/app/testplan/${!this.dataForm.testplanId ? 'savelist' : 'update'}`),
              method: 'post',
